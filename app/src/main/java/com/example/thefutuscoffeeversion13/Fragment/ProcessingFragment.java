...
import com.example.thefutuscoffeeversion13.Helper.UserProcessingTouchHelper;
...
public class ProcessingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //load data
        RecyclerView rvProcessing = view.findViewById(R.id.rvProcessing);
        FirebaseFirestore db = FirebaseFirestore.getInstance();
        rvProcessing.setLayoutManager(new GridLayoutManager(getActivity(), 1));
        List<OrderModel> orderModelList = new ArrayList<>();
        CardUserOrderAdapter cardUserOrderAdapter = new CardUserOrderAdapter(getActivity(), orderModelList);
        rvProcessing.setAdapter(cardUserOrderAdapter);
        ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new UserProcessingTouchHelper(cardUserOrderAdapter));
        itemTouchHelper.attachToRecyclerView(rvProcessing);
        loadOrderHistoryForUser(db, userEmail, orderModelList, cardUserOrderAdapter);
        return view;
    }
