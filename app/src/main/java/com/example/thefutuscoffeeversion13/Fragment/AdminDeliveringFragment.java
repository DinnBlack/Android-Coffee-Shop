 ...
 * Use the {@link AdminDeliveringFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AdminDeliveringFragment extends Fragment {
    ...
    public AdminDeliveringFragment() {
     ...
     * @return A new instance of fragment AdminDeliveringFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static AdminDeliveringFragment newInstance(String param1, String param2) {
        AdminDeliveringFragment fragment = new AdminDeliveringFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_admin_delivering, container, false);
        ...
        //load data
        RecyclerView rvAdminProcessing = view.findViewById(R.id.rvAdminDelivering);
                            ...
                            .addOnCompleteListener(userOrderTaskResult -> {
                                if (userOrderTaskResult.isSuccessful()) {
                                    for (QueryDocumentSnapshot orderDocument : Objects.requireNonNull(userOrderTaskResult.getResult())) {
                                        if (orderDocument.getString("status").equals("Đang giao hàng")) {
