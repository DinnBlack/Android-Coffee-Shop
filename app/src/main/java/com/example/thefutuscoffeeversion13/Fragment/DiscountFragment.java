...
public class DiscountFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cardVoucherModelList = new ArrayList<>();
        cardVoucherAdapter = new CardVoucherAdapter(getActivity(), cardVoucherModelList);
        rvCardVoucher.setAdapter(cardVoucherAdapter);

        dbVoucher.collection("Products").document("Voucher").collection("Voucher")
                .get()
